...
function AfricanBG({ children }) {
  return (
    <View style={{ flex: 1, backgroundColor: C.bg }}>
      ...
      <View
        style={[
          bg.b,
          {
            ...
            borderRadius: 110,
            borderWidth: 1,
            borderColor: "rgba(200,134,10,0.11)",
            top: -70,
            left: -70,
          },
        ]}
      ...
      />
      {[
        { top: H * 0.12, left: W * 0.06, o: 0.28 },
        { top: H * 0.2, left: W * 0.9, o: 0.18 },
        { top: H * 0.75, left: W * 0.88, o: 0.2 },
      ].map((d, i) => (
        <View
          key={i}
          style={[bg.dot, { top: d.top, left: d.left, opacity: d.o }]}
        />
      ))}
      {children}
    </View>
  ...
  return (
    ...
    >
      <View style={{ flexDirection: "row", alignItems: "center", gap: 8 }}>
        ...
        />
        <Text style={{ color: C.cream, fontSize: 16, fontWeight: "800" }}>
          {text}
        </Text>
      </View>
      {actionLabel && (
...
function StreakBanner({ streak }) {
  ...
  return (
    <FadeSlide delay={180} style={sb.wrap}>
      <View style={sb.inner}>
        <Animated.View
          style={[sb.shimmer, { transform: [{ translateX: shimmer }] }]}
        />
        <View style={sb.left}>
  ...
  if (loading) {
    return (
      <View style={[ss.card, { alignItems: "center", paddingVertical: 36 }]}>
        ...
        <Text style={{ color: C.creamDim, fontSize: 12, marginTop: 12 }}>
          Loading your skin data…
        </Text>
      </View>
    );
  }
      ...
      <View style={ss.card}>
        ...
        <View style={ss.empty}>
          ...
          <Text style={ss.emptyBody}>
            Your skin profile will appear here after your first scan. We'll
            identify your skin type and any visible conditions.
          </Text>
          <TouchableOpacity
            style={ss.emptyCta}
            onPress={onScanPress}
      ...
      {conditions.length > 0 && (
        ...
        >
          ...
          {conditions.length > 3 && (
            ...
            >
              <Text style={{ color: C.creamDim, fontSize: 11 }}>
          ...
          >
            <View
              style={{
                width: `${latest}%`,
                height: "100%",
                backgroundColor: scoreColor(latest),
                borderRadius: 3,
              }}
            />
          </View>
  ...
  return (
    <FadeSlide delay={delay} style={{ marginBottom: 10 }}>
      <View style={[tip.card, { borderColor: accent || C.border }]}>
        <View
          style={[tip.iconBadge, { backgroundColor: "rgba(200,134,10,0.12)" }]}
        >
    ...
    <AfricanBG>
      ...
      >
        ...
        <FadeSlide delay={0} style={s.topBar}>
          ...
          <Text style={s.greetSkin}>Skin Journey</Text>
        </FadeSlide>
